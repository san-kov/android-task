...
public class SeasonDamage {
    ...
    @Expose
    private Metadata____________ metadata;
    ...
    public Metadata____________ getMetadata() {
        return metadata;
    }

    public void setMetadata(Metadata____________ metadata) {
