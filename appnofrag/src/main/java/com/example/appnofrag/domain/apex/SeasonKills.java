...
public class SeasonKills {
    ...
    @Expose
    private Metadata_____________ metadata;
    ...
    public Metadata_____________ getMetadata() {
        return metadata;
    }

    public void setMetadata(Metadata_____________ metadata) {
