...
public class EnvironmentalKills {
    ...
    @Expose
    private Metadata_______________ metadata;
    ...
    public Metadata_______________ getMetadata() {
        return metadata;
    }

    public void setMetadata(Metadata_______________ metadata) {
